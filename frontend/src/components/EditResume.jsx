...
const EditResume = () => {
    ...
    const [openThemeSelector, setOpenThemeSelector] =
        useState(false);
            ...
            case "skills":
                ...
                resumeData.skills.forEach(
                    (
                        ...
                        if (!name.trim())
                            errors.push(
                                `Skill name is required in skill ${index + 1}`
                            );
            ...
            if (
                ...
                setResumeData(
                    (prevState) => ({
                        ...
                        thumbnailLink:
                            resumeInfo?.thumbnailLink ||
                            prevState.thumbnailLink,
        ...
        try {
            ...
            const uploadResponse =
                await axiosInstance.put(
                    ...
                    API_PATHS.RESUME.UPLOAD_IMAGES(
                        resumeId
                    ),
            ...
            if (!thumbnailLink) {
                ...
                throw new Error(
                    "Thumbnail URL was not returned by server"
                );
            }
    ...
    return (
        ...
        <DashboardLayout>
            ...
            ==================================================
                ...
                html2canvas needs the element to have
                actual dimensions.

                We move it outside the visible screen instead.
            ================================================== */}
            ...
            >
                ...
                <div
                    className={
                        containerStyles.hiddenThumbnail
                    }
                >
