  ...
  return (
    <>
        ...
        border border-white/10'>
         ...
         {/* MAIN PRoGRESS BAR*/}
         <div className='relative h-full bg-linear-to-r from-violet-500 via-fuchsia-500 to-violet-600 animate-flow bg-[length:200%_100%] transition-all duration-700 ease-out rounded-full overflow-hidden animate-pulse-glow ' 
        ...
        <div className='absolute inset-0'>
         ...
         {progress >0&&(
            <div className='absolute top-0 h-full w-8 bg-linear-to-r from-transparent via-white/60 to-white/30 blur-sm' style={{left:`${Math.max(0,progress-4)}%`}}>
        ...
        <div className='flex justify-between items-center mt-3'>
            ...
            <div className='flex items-center gap-2'>
                {progress===100&&(
                    <div className='w-6 h-6 bg-linear-to-r from-green-500 to-emrald-500 rounded-full
