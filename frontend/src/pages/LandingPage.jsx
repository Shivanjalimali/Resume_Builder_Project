...
import { ArrowRight, LampDesk, LayoutTemplate, Menu ,X} from 'lucide-react'
  ...
  return (
    <div className={landingPageStyles.container}>
        ...
        <main className={landingPageStyles.main}>
                ...
                <div className={landingPageStyles.heroGrid}>
                    ...
                    <div className={landingPageStyles.heroLeft}>
                        ...
                        <p className={landingPageStyles.description}>
                            ...
                            ATS-friendly,recruiter-approved,and tailored to ypur career goals.
                        </p>
                                ...
                                >
                                    ...
                                    <defs>
                                        <linearGradient id="bgGradient" x1="0%" y1="0%" x2="100%" y2="100%">
                                            <stop offset="0%" stopColor="#6232d0ff" />
                                            <stop offset="100%" stopColor="#a216b7ff" />
                                        </linearGradient>
                          ...
                          {[
                                ...
                                <div key={index} className={landingPageStyles.featureCard}>
                                    ...
                                    <div className={`${landingPageStyles.featureCardContent} ${feature.bg}`}>
                                        ...
                                        <h3 className={landingPageStyles.featuresTitle}>
                                                {feature.title}
                                        </h3>
            ...
            {/*CTA SECTION*/}
            <section>
                <div className={landingPageStyles.ctaSection}>
